...
import { matrixInterval } from "./cmds/matrix.js";

const msg = "Logged in to why-kartik server from " + navigator.platform + "!";
...
Heyyoo! I'm <span data-color="cyan"><a href="https://www.linkedin.com/in/yadla-kartik-8a9357272/">Yadla Kartik</a></span>, a self-taught <span data-color="#00ff99">Web Developer</span> and hobbyist <span data-color="#00ff99">Competitive Programmer</span> from <span data-color="#00ff99">India</span>
<span>Love building cool projects and solving real problems.</span>
<span data-color="#00ff99">Don't like terminal style??</span> Type <span data-color="cyan">gui</span>
  ...
  window.onkeydown = async (e) => {
    ...
    if (e.ctrlKey && e.key === "c") {
      if (matrixInterval !== null) {
        ...
        terminal.innerHTML += "\n<span data-color='red'>^C Stopped.</span>\n";
